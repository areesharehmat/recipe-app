                ...
                <form onSubmit={submitForm}>
                    ...
                    <div className="mb-4">
                        ...
                        <input
                            ...
                            placeholder="eg. Vanilla Cupcakes"
                            required
                            value={title}
                    ...
                    <div className="mb-4">
                        ...
                        <textarea
                            ...
                            className="border rounded w-full py-2 px-3"
                            rows="4"
                            placeholder="soft, moist and warm"
                            value={description}
                    ...
                    <div className='mb-4'>
                        <button
                                className='bg-pink-500 hover:bg-indigo-600 text-white font-bold py-2 px-4 rounded-full w-full focus:outline-none focus:shadow-outline'
                                type='submit'>
                                Submit Recipe
                        </button>
                    </div>
